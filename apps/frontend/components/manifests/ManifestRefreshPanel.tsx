        ...
        <header className="flex flex-col gap-2 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <button
              ...
              className="rounded-full bg-[var(--accent-primary)] px-5 py-2 text-xs font-semibold uppercase tracking-[0.25em] text-black shadow-[0_0_18px_rgba(34,197,94,0.35)] transition hover:shadow-[0_0_22px_rgba(34,197,94,0.5)] disabled:cursor-not-allowed disabled:opacity-60"
            >
