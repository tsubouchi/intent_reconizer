...
export type FirestoreSessionDocument = DocumentType<Collections['sessions']>;
export type FirestoreIntentEventDocument = DocumentType<Collections['intentEvents']>;

export const firestoreContract = schema;
